...
public class Req15GameVictoryRulesTest {
    ...
    void testTwoPlayerGameVictory() {
        ...
        assertNull(playerList.getGameWinnerCandidates(), "No winner should be declared at 6 tokens");
    ...
    void testFourPlayerGameVictory() {
        ...
        assertNull(playerList.getGameWinnerCandidates(), "No winner should be declared at 3 tokens");
